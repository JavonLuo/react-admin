...
export default class Category extends Component {
    state = {
        ...
        visible: 0, //代表连个modal框都不显示 1代表显示修改的modal框 2代表显示修改的
        ...
        this.columns = [
            ...
            },
            {
              ...
              render:(category)=>{
                return (
                    <span>
                    <Button type='link' onClick={this.showUpteModal.bind(null,category)}>修改分类</Button>
                    {this.state.parentId==='0'?
                    <Button type='link' onClick={this.showSubCategorys.bind(null,category)}>查看子分类</Button>
                    :null}
